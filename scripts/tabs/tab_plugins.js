...
`
    ...
    if (!multiplayer_support) {
        ...
        socketio.addEventListener("load", () => {
            ...
            const socket = globalThis.socket = location.href.includes("discord") ? io("https://1403677664514146325.discordsays.com/discord-multiplayer-host", { transports: ["websocket"], path: "discord-multiplayer-host/socket.io/" }) : io(params.get("multiplayer"), {transports: ["websocket"]});
