...
function ModMenu(title, tabs, rootDivId = "menu", style = undefined) {
    ...
    this.init = function (instanceOpts) {
        ...
        this._injectStyle(
            `#${rootDivId} { all:initial; color: ${this.style._style.textColor}; user-select: none; font-family: sans-serif; position: fixed; z-index: 89999999; background-color: ${this.style._style.background}; border: 1px solid #d3d3d3; width:${this.style._style.width}; height:${this.style._style.height}; resize:both; overflow-y:scroll; top: 50%; left:50%; transform: translate(-50%, -50%); border-radius: 0.5rem; box-shadow: 2px 2px 52px 0px rgba(0,0,0,1)}
