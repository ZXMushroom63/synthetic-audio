...
document.querySelector = function (sel) {
    if (memoizedVer[sel]) {
        return memoizedVer[sel];
    }
    const canMemoize = sel.startsWith("#") && !sel.includes(" ") && !sel.includes(">") && !sel.includes(":") && !sel.includes("*") && sel.includes(":memoize;");
    sel = sel.replace(":memoize;", "");
