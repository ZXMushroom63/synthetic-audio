 ...
 * slightly modded by ZXMushroom63 to remove inbuilt WAV exporter, and to add it as a filter node
 *
...
addBlockType("samjs", {
    ...
    customGuiButtons: {
        Preview: async function () {
            ...
            debugger;
            var pcmData = filters["samjs"].functor.apply(this, [new Float32Array(audio.samplerate), 0, {}]);
    ...
    functor: function (inPcm, channel, data) {
        ...
        var pre = SamJs.buf32(SamJs.convert(this.conf.Text), {
            ...
            speed: Math.floor(this.conf.Speed * 255),
            mouth: Math.floor(this.conf.Mouth * 255),
